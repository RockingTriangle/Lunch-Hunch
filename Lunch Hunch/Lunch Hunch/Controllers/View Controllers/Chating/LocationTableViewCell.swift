...
class LocationTableViewCell: UITableViewCell {
    ...
    func setLocationOnMap(latitude: Double, longitude: Double) {
        ...
        // Added categories to INCLUDE on map view
        let categories = [MKPointOfInterestCategory.bakery, MKPointOfInterestCategory.brewery, MKPointOfInterestCategory.cafe, MKPointOfInterestCategory.foodMarket, MKPointOfInterestCategory.nightlife, MKPointOfInterestCategory.restaurant, MKPointOfInterestCategory.store, MKPointOfInterestCategory.winery]
